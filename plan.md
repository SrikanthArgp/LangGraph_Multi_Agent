...
├── infra/                           # NEW (Phase 15–16): Terraform root — providers, S3+DynamoDB remote state, Lambda/API Gateway/CloudFront resources (Phase 15), ECS/ALB resources added in Phase 16, EKS cluster/node-group/IRSA resources added in Phase 20
