...
export default function ChatSessionPage() {
  ...
  // Keyed by sessionId: switching chats should reset all local state (history,
  // draft input, streaming status) rather than carry it over, and a `key` gets that
  // for free via remount instead of a "reset state in an effect" anti-pattern.
  return <ChatSessionView key={params.sessionId} sessionId={params.sessionId} />;
}
